...
bool Tour::estDeplacementValide(const Position& depart, const Position& arrivee, Echiquier& echiquier)  const {
...
std::vector<Position> Tour::getListeDeplacementsValide(const Position& départ, const Echiquier& echiquier) const {
